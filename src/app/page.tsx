import { FaqSection } from "@/components/common/accordion";
          ...
          faqs={[
            {
              ...
              answer: 'Durante a sessão, você é convidado a associar livremente, ou seja, falar o que lhe vier à cabeça. Da forma mais livre possível, sem se preocupar com o sentido, ordem cronológica, ou qualquer outra coisa. As sessões duram, em média, 50 minutos e são feitas por videochamada ou presencial com data e hora marcada — geralmente com frequência semanal.',
            },
            {
              question: 'Análise online funciona?',
              answer: 'O que se analisa em um processo analítico é o discurso produzido pela pessoa, não importando tanto suas expressões faciais, gestos ou jeito. Sendo assim, é completamente possível fazer análise de forma não presencial, sendo essa uma escolha de preferência pessoal.',
            },
            {
...
O que se faz na análise é pensar o diagnóstico como um todo, entender os sintomas, sua história, sua função e, a partir da singularidade de cada pessoa, aprender a lidar com eles da melhor forma.É a partir da relação da pessoa com seu sintoma e da forma como ela narra sobre seu sofrimento que se propõe a pensar formas para lidar com eles.`
            },
            {
              ...
              answer: 'Não, eu não trabalho com nenhum convênio. No entanto, caso o seu convênio faça reembolso, posso fornecer recibos das sessões. '
            },
            {
              question: 'Como faço para agendar?',
              answer: 'Clique no botão abaixo para marcar nossa conversa inicial. Ela serve para nos conhecermos, você tirar suas dúvidas e entender se é mesmo o que procura, além de definirmos os valores, horários e a frequência. Caso queira prosseguir, agendamos a primeira sessão.'
            }
          ]}
        />
      </div>
